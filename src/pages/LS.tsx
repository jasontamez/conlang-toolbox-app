					...
					<IonItem>
						<ol>
							...
							<li><ol>
								...
								<li><ol>
									...
									<li><ul>
										...
										<li>Human languages handle these in five distinct ways:
											<ol>
												<li className="x"><strong>[2.3.1.1]</strong> <em>Lexicalized as verbs (austronesian languages)</em></li>
												<li className="x"><strong>[2.3.1.2]</strong> <em>Lexicalized as nouns (Finnish)</em></li>
												<li className="x"><strong>[2.3.1.3]</strong> <em>Lexicalized as nouns or verbs depending on the demand of discourse (Dutch)</em></li>
												<li className="x"><strong>[2.3.1.4]</strong> <em>Some are lexicalized as nouns, others are lexicalized as verbs (Yoruba)</em></li>
												<li className="x"><strong>[2.3.1.5]</strong> <em>Distinct class of "adjectives" (English)</em></li>
											</ol>
										</li>
										<li>Which way does the language handle PCs?</li>
										<li>Do they agree with their head?</li>
									</ul></li>
									<li className="x x3"><strong>[2.3.2]</strong> <em>Non-Numeral Quantifiers</em></li>
									<li><ul>
										<li>e.g. Few, many, some, etc</li>
										<li>Which quantifiers exist?</li>
									</ul></li>
									<li className="x x3"><strong>[2.3.3]</strong> <em>Numerals</em></li>
									<li><ol>
										<li className="x"><strong>[2.3.3.1]</strong> <em>Extent</em></li>
										<li><ul>
											<li>Some languages have limited numerals: e.g. "1, 2, 3, many"</li>
											<li>More languages have distinct numerals from 1 to Infinity</li>
										</ul></li>
										<li className="x"><strong>[2.3.3.2]</strong> <em>Base</em></li>
										<li><ul>
											<li>Usually base 5 or 10. Sometimes base 20.</li>
										</ul></li>
										<li className="x"><strong>[2.3.3.3]</strong> <em>Agreement</em></li>
										<li><ul>
								...
								<li className="x x2"><strong>[2.4]</strong> <em>Adverbs: a "Catch All" Category</em></li>
								<li><ol>
								</ol></li>
							</ol></li>
							<li className="x x1"><strong>[3]</strong> <em>Constituent Order Typology</em></li>
							<li className="x x1"><strong>[4]</strong> <em>Noun and Noun Phrase Operations</em></li>
							<li className="x x1"><strong>[5]</strong> <em>Predicate Nominals and Related Constructions</em></li>
							<li className="x x1"><strong>[6]</strong> <em>Grammatical Relations</em></li>
							<li className="x x1"><strong>[7]</strong> <em>Voice and Valence Adjusting Operations</em></li>
							<li className="x x1"><strong>[8]</strong> <em>Other Verb and Verb Phrase Operations</em></li>
						</ol>
					</IonItem>
				</IonList>
			</IonContent>
