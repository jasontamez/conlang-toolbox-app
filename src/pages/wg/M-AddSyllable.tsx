...
const AddSyllableModal = () => {
	...
	const maybeSaveNewCat = () => {
		...
		// Everything ok!
		dispatch(closeModal('AddSyllable'));
	...
	return (
		<IonModal isOpen={modalState.AddSyllable} onDidDismiss={() => dispatch(closeModal('AddSyllable'))}>
			<IonHeader>
				<IonToolbar color="primary">
					<IonTitle>Add Category</IonTitle>
					<IonButtons slot="end">
						<IonButton onClick={() => dispatch(closeModal('AddSyllable'))}>
...
export default AddSyllableModal;
