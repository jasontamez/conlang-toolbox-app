...
import {
	...
	HeaderItem,
	InfoModal,
	SyntaxHeader, TextItem, TransTable
...
const Syntax = (props: PageData) => {
	...
	const viewInfo = { key: "ms" as keyof ViewState, page: "ms07" };
	useIonViewDidEnter(() => {
		...
		<IonPage>
			...
			>
				<IonList lines="none" className="hasSpecialLabels">
							...
							<li><strong>Valence</strong> refers to the amount of arguments in a clause.
								<ul>
									...
									<li>"I gave a coconut to Steve" has a valence of 2.
										<ul><li>"To Steve" is in an oblique case, forming a verb modifier instead of being an argument of the verb.</li></ul>
									</li>
								</ul>
							</li>
						</ul>
					...
					<HeaderItem level={3}>7.1.1. Causatives</HeaderItem>
					<InfoModal
						title="Causatives"
									...
									<li>Most languages have at least some form of this. There are three major methods employed:
										<ul>
											<li>No change in the verb:
												<ul><li>"The vase broke" becomes "Steve broke the vase".</li></ul>
											</li>
											<li>Some idiosyncratic change in the verb:
												<ul><li>"The tree fell" becomes "Steve felled the tree".</li></ul>
											</li>
											<li>Different verb:
												<ul><li>"The tree died" becomes "Steve killed the tree".</li></ul>
											</li>
										</ul>
									</li>
								</ul>
											...
											<li>Analytic causatives often "require" an animate causee.
												<ul>
													<li>Japanese has a morphological causative when the causee has some control over the event, but requires a lexical causative for inanimate causees.
														<ul><li>Consider "Joe made George come down" vs "Joe brought the golf clubs down".</li></ul>
													</li>
												</ul>
											</li>
										</ul>
									...
									<li><strong>Case</strong>
										<ul>
											<li>If the causee retains a high degree of control, it will appear in a case associated with Agents, but with little control, will appear in a Patient case.
												<ul><li>Ex: "Steve asked that <em>he</em> leave" gives Steve less control over the situation than "Steve asked <em>him</em> to leave".</li></ul>
											</li>
										</ul>
									</li>
								</ul>
					...
					<TextItem
						...
						rows={4}
					>Describe which method(s) the language uses to create causatives.</TextItem>
					<HeaderItem level={3}>7.1.2. Applicatives</HeaderItem>
					<InfoModal
						title="Applicatives"
					...
					<TextItem
						...
						rows={4}
					>Describe which method(s) the language uses for applicatives, if any.</TextItem>
					<HeaderItem level={3}>7.1.3. Dative Shift</HeaderItem>
					<InfoModal
						title="Dative Shift"
					...
					<TextItem
						...
						rows={4}
					>Is there a dative shift construction in the language? What is it? What semantic roles can be shifted? Is it obligatory?</TextItem>
					<HeaderItem level={3}>7.1.4. Dative of Interest</HeaderItem>
					<InfoModal
					...
					>
						<ul>
							<li>This is adding a participant that is associated in some way.
								<ul>
									<li>"Dinner is burned [for me]" in Spanish<br /><TransTable rows="Se me quemó la cena. / REFL 1s burn.3s.PST DEF.f.s din&shy;ner" /></li>
									<li>"She cut the hair [on him]" in Spanish.<br /><TransTable rows="Le cortó el pelo. / 3.DAT cut.3s.PST DEF.M.s hair" /></li>
								</ul>
							</li>
						</ul>
					</InfoModal>
					<TextItem
						...
						value={TEXT_datOfInt}
						rows={4}
					>Is there a dative-of-interest operation?</TextItem>
					<HeaderItem level={3}>7.1.5. Possessor Raising (a.k.a. External Possession)</HeaderItem>
					<InfoModal
					...
					<TextItem
						...
						rows={4}
					>Does possessor raising occur?</TextItem>
							...
							<li className="newSection">Lexical reflexives:
								<ul>
									<li>The verb itself implies reflexivity.
										<ul><li>e.g.: Steve washed and shaved every morning.</li></ul>
									</li>
								</ul>
							</li>
							<li>Morpholigical reflexives:
								<ul>
									<li>A word (or words) is modified to indicate the reflexive.
										<ul><li>e.g.: Spanish: Jorge se lavo. (George washed himself, "se lavo" being a morphing of the root verb "lavarse".)</li></ul>
									</li>
								</ul>
							</li>
							<li>Analytic reflexives:
								<ul>
									<li>Inserting a lexical word, making a semantic valence-lowering (but not a lexical one).
										<ul><li>e.g.: Steve washed himself.</li></ul>
									</li>
									<li>These are often based on body parts.
										<ul><li>e.g.: Another face in the crowd; Move your butt!</li></ul>
									</li>
								</ul>
							</li>
						</ul>
					...
					<TextItem
						...
						value={TEXT_refls}
						rows={4}
					>How are reflexives handled?</TextItem>
							...
							<li className="newSection">Lexical reciprocals:
								<ul>
									<li>The verb itself implies reciprocity.
										<ul><li>e.g.: Steve and Jane shook hands [with each other].</li></ul>
									</li>
								</ul>
							</li>
					...
					<TextItem
						...
						value={TEXT_recips}
						rows={3}
					>How are reciprocals handled?</TextItem>
					...
					>
						<ul>
							...
							<li className="newSection">Personal passive: Agent is implied, or expressed obliquely.
								<ul>
									...
									<li>English has analytic passives, with a copula and a "past participle" (Patient nominalization).
										<ul><li>e.g.: The tree has been killed.</li></ul>
									</li>
								</ul>
							</li>
							<li className="newSection">Impersonal passive: no Agent directly indicated; can be used for intransitive verbs as well as transitive.
								<ul><li>No known languages uses a specific morphology for this!</li></ul>
							</li>
					...
					<TextItem
						...
						value={TEXT_passives}
						rows={4}
					>How are passives handled?</TextItem>
					...
					<CheckboxItem
						display={{
							class: "cols2",
							boxesPerRow: 1,
							rowLabels: ["Marked inverse only", "Both direct and inverse explicitly marked", "Special verb agreement markers for inverse", "Functional inverse: word order changes, e.g. VAP becomes VPA"],
							export: {
					...
					<TextItem
						...
						value={TEXT_inverses}
						rows={4}
					>Describe any peculiarities of inverse constructions.</TextItem>
					...
					<TextItem
						...
						rows={3}
					>How are middle constructions handled?</TextItem>
					...
					<TextItem
						...
						value={TEXT_antiP}
						rows={3}
					>Describe antipassive strategies in the language, if they exist.</TextItem>
							...
							<li className="newSection"><strong>Incorporation</strong>: "Steve shot Bob" becomes "Steve Bob-shot".
								<ul>
									...
									<li>May have other semantic functions.
										<ul><li>In Panare, incorporating a body part noun into a cutting verb means the part was cut completely off ("Darth Vader hand-cut"), whereas leaving it unincorporated means it was merely injured ("Darth Vader cut hand").</li></ul>
									</li>
								</ul>
							</li>
						</ul>
					...
					<TextItem
						...
						rows={5}
					>Is object demotion/omission allowed? How about incorporation?</TextItem>
				</IonList>
			</IonContent>
		</IonPage>
	);
