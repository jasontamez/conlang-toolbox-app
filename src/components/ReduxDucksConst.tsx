...
export const SET_LEXICON_COLUMN_WG = p+"SET_LEXICON_COLUMN_WG";
...
export const TOGGLE_SHOW_CHANGES_WE = p+"TOGGLE_SHOW_CHANGES_WE";
export const TOGGLE_SHOW_RULES_WE = p+"TOGGLE_SHOW_RULES_WE";
