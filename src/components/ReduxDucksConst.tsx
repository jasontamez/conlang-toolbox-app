...
//export const SET_SORT_SENSITIVITY = p+"SET_SORT_SENSITIVITY";
...
export const CANCEL_EDIT_CHARACTER_GROUP_WG = p+"CANCEL_EDIT_CHARACTER_GROUP_WG";
export const DO_EDIT_CHARACTER_GROUP_WG = p+"DO_EDIT_CHARACTER_GROUP_WG";
export const DELETE_CHARACTER_GROUP_WG = p+"DELETE_CHARACTER_GROUP_WG";
...
export const SET_CHARACTER_GROUP_DROPOFF_WG = p+"SET_CHARACTER_GROUP_DROPOFF_WG";
...
export const ADD_CHARACTER_GROUP_WE = p+"ADD_CHARACTER_GROUP_WE";
export const START_EDIT_CHARACTER_GROUP_WE = p+"START_EDIT_CHARACTER_GROUP_WE";
export const CANCEL_EDIT_CHARACTER_GROUP_WE = p+"CANCEL_EDIT_CHARACTER_GROUP_WE";
export const DO_EDIT_CHARACTER_GROUP_WE = p+"DO_EDIT_CHARACTER_GROUP_WE";
export const DELETE_CHARACTER_GROUP_WE = p+"DELETE_CHARACTER_GROUP_WE";
...
export const UPDATE_LEXICON_COLUMNAR_INFO = p+"UPDATE_LEXICON_COLUMNAR_INFO";
export const ADD_ITEMS_TO_LEXICON_COLUMN = p+"ADD_ITEMS_TO_LEXICON_COLUMN";
export const UPDATE_LEXICON_SORT = p+"UPDATE_LEXICON_SORT";
export const UPDATE_LEXICON_SORT_DIR = p+"UPDATE_LEXICON_SORT_DIR";
export const MERGE_LEXICON_ITEMS = p+"MERGE_LEXICON_ITEMS";

export const ADD_CUSTOM_HYBRID_MEANING = p+"ADD_CUSTOM_HYBRID_MEANING";
export const DELETE_CUSTOM_HYBRID_MEANINGS = p+"DELETE_CUSTOM_HYBRID_MEANINGS";

export const UPDATE_CONCEPTS_DISPLAY = p+"UPDATE_CONCEPTS_DISPLAY";
export const TOGGLE_CONCEPTS_BOOLEAN = p+"TOGGLE_CONCEPTS_BOOLEAN";
